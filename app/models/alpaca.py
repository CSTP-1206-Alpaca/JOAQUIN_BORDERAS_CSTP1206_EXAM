class Alpaca(object):
    ...
    def __init__(self, id2, name, dName, bio, age, hobbiesList, contactList, sex):
        self.id = id2
        self.name = name
        self.dName = dName
        self.bio = bio
    ...
    def get_all(self, age=None):
        ...
        return results
alpaca_model=Alpaca(id2=None, name=None, dName=None, bio=None, age=None, hobbiesList=None, contactList=None, sex=None)